                ...
                <div className="books__container">
                    <div className="row">
                            ...
                            <div className="cart__body">
                                ...
                                <div className="cart__item">
                                    <div className="cart__book">
                                        ...
                                        <div className="cart__book--info">
                                            <span className="book__title">Temp Title</span>
                        ...
                        <div className="total">
                            ...
                            <button className="btn btn__checkout no-cursor" onClick={() => alert("Haven't implemented this feature yet!")}>Proceed to checkout</button>
                        </div>
                    </div>
                </div>
            </main>
